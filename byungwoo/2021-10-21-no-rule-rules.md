...
이 책의 구성은 총 4부로 이루어져 있다. 위의 그림에 나오는 3단계가 1~3부에 해당하며 1~3단계는 3개의 축으로 이루어져 있다. 마지막 4부는 세계에 진출해 있는 넷플릭스가 그 문화를 정착시키면서 겪었던 경험을 컬쳐맵으로 표현하면서 마무리한다.
...
### 자유와 책임(Freedom and Responsibility), 통제가 아닌 맥락으로 리드하라
