...
이 책의 구성은 총 4부로 이루어져 있다. 위의 그림에 나오는 좌측에서 우측으로 3단계가 1-3부에 해당하며 상단에서 하단으로 3개의 핵심 가치로 구성되어 있다. 마지막 4부는 넷플릭스가 전 세계에 진출하면서 그 문화를 정착시키면서 겪었던 경험을 컬쳐맵으로 표현하면서 마무리한다.
