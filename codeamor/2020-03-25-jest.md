...
- [✨**사용법**](#%EC%82%AC%EC%9A%A9%EB%B2%95)
  - [**덧셈 함수**](#%EB%8D%A7%EC%85%88-%ED%95%A8%EC%88%98)
...
- [✨**목Mock 함수 테스팅**](#%EB%AA%A9mock-%ED%95%A8%EC%88%98-%ED%85%8C%EC%8A%A4%ED%8C%85)
- [**Reference**](#reference)
...
개별 테스트(여기서는 테스트가 외부, 내부 각각 하나지만)의 전후에 실행될 코드는 beforeEach(), afterEach()을 사용합니다.
