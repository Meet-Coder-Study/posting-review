...
글을 읽기 전에 공부를 목적으로 정리 해놨기 때문에 정확하지 않을 수 있습니다. 

궁금한 부분이나 이상한 부분에 대해서는 24시간 언제든지 연락주세요
...
( Gradle: ch.qos.logback:logback-access:1.2.3의 경우 

logback-classic만 받아도 자동적으로 내부에서 등록됩니다. 
